...
# This is a Python language implementation of the Automated Password
...
# for Automated Password Generator".  In accordance with the standard,
# the results obtained from this program are logically equivalent to
